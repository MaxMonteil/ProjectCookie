...
class Course {
    ...
    protected static $userJoinCourseTable = 'userJoinCourse';
    ...
    public static function getCoursesTakenBy($user) {
        ...
        return App::get('database')->selectByAttrValues(static::$userJoinCourseTable, 'UserID', ['UserID'=>$user['UserID']], $columns1);
    }
    ...
    public static function getCourseProg($course, $user) {
        ...
        return App::get('database')->selectOne(static::$userJoinCourseTable, ['CourseID'=>$course['CourseID'], 'UserID'=> $$user['UserID']], $columns);
    }

    public static function updateCourseProg($course, $user) {
        App::get('database')->update(static::$userJoinCourseTable, ['CourseProgress'=>$course['CourseProgress']], ['CourseID'=>$course['CourseID'], 'UserID'=> $user['UserID']]);
    }
